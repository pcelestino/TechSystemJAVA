...
public class MenuVisualizarCadastros implements ActionListener {
    ...
    public MenuVisualizarCadastros(PainelMenuBar painelMenuBar) {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        telaPrincipal.getPainelCards().getPainelViCadastros().carregarComponentes();

        // Ativa o painel de edição de vendas
        telaPrincipal.getPainelCards().setPainel("VisualizacaoCadastros");
    }
